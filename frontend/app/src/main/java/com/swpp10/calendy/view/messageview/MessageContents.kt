...
import com.swpp10.calendy.ui.theme.Blue1
import com.swpp10.calendy.utils.toTimeString
import com.swpp10.calendy.view.messageview.ManagerResponse.FAIL_REVISION_1
import com.swpp10.calendy.view.messageview.ManagerResponse.FAIL_REVISION_2
import com.swpp10.calendy.view.messageview.ManagerResponse.SUCCESS_REVISION
import com.swpp10.calendy.view.popup.PlanModifiedListPopup
...
fun MessageContentManagerWithRevision(
    messageLog: Message,
    callback: (Any) -> Unit = {},
    messageContentViewModel: MessagePlanLogViewModel = viewModel(factory = com.swpp10.calendy.AppViewModelProvider.Factory)
) {
